...
class RewardModel(nn.Module):
    ...
    def forward(self,
        ...
        if self.case == 0:
            ...
            transformer_outputs = self.rwmodel.lm(
                input_ids,
                past_key_values=past_key_values,
                attention_mask=attention_mask,
                inputs_embeds=inputs_embeds,
        ...
        elif hasattr(self.rwmodel, "embed_out"):
            lm_logits = self.rwmodel.embed_out(hidden_states)
        else:
